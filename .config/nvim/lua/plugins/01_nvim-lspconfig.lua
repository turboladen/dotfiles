...
local function setup_regular_lsps(lsp_config, capabilities)
  ...
  require("turboladen.lsp.deno").setup(lsp_config, capabilities)
  require("turboladen.lsp.efm").setup(lsp_config, capabilities)
  require("turboladen.lsp.emmet_ls").setup(lsp_config, capabilities)
  require("turboladen.lsp.eslint").setup(lsp_config, capabilities)
  require("turboladen.lsp.html").setup(lsp_config, capabilities)
  require("turboladen.lsp.jsonls").setup(lsp_config, capabilities)
  require("turboladen.lsp.lua_ls").setup(lsp_config, capabilities)
  -- require("turboladen.lsp.ruby_analyzer").setup(lsp_config, capabilities)
  require("turboladen.lsp.yamlls").setup(lsp_config, capabilities)
end
